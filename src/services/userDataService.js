...
export const registrateUser = (body = {}) => {
    return httpClientHelper.post(`registration`, { ...body });
}
...
export const getIngredients = () => {
    return httpClientHelper.get(`/food/ingredients`);
}
    ...
    return [
        {
            ...
            Обычно фриттату готовят на плите, затем доводят до готовности в духовке.`,
                ...
                },
                {
                    ...
                    kkal: 500,
                    description: `400 рублей за кусочек, они ***********`,
                    avPrice: 500,
                    avTime: 3445,
                    checked: true
                },
